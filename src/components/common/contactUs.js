        ...
        <div className="overlay-bg"></div>
          <Row className="contact-text">
            ...
            <Col lg={6} xl={6} className="mb-4">
              ...
              <p className="text-light my-4"> <i className="fas fa-map-marker-alt me-3"></i>
              <span className="text-light">ILINK Development Services Pte. Ltd.</span></p>

              <p className="text-light ct-mail"> <i className="fas fa-envelope me-3"> </i>
              <a href="mailto:info@ilinkdev.in">info@ilinkdev.in </a></p>

              <p className="text-light ct-number"> <i className="fas fa-phone-alt me-3"> </i>
